export default [
	...
	[
		'A rectangular channel has a width of $4.00\,\mathsf{m}$ and a slope of $0.1\%$. For a discharge of $4.80\,\mathsf{m^3\!/s}$, the depth is measured to be $850\\,\\mathsf{mm}$. Determine the average flow velocity for these conditions. Also, determine the discharge and average flow velocity when the depth is $1.700\,\mathsf{m}$.',
		...
		`$$ { v_{(0.850\\,\\mathsf{m})}} = 1.412\\,\\mathsf{m/s},\\quad  {Q_{(1.700\\,\\mathsf{m})}} = 12.81\\,\\mathsf{m^3/s}, \\quad { v_{(1.700\\,\\mathsf{m})}} = 1.883\\,\\mathsf{m/s} $$`,
	],

	[
		// problem statement
		`A rectangular channel with a base of !$ 6.25\\,\\mathsf{m} !$ has a depth of !$y = 1.650\\, \\mathsf{m} !$ when the discharge (volume flow rate) is !$ Q=23.5 \\,\\mathsf{m^3\\!/s} !$. 
        Determine !$E!$, the specific energy, and classify the flow.`,
		// part solutions
		[
			[
				`Determine !$v!$, the average flow velocity.`,
				`$$     
                    \\begin{aligned}
                        A &= b \\cdot y \\\\ 
			...
			[
				`Determine !$E!$, the specific energy.`,
				`$$
                    \\begin{aligned}
                        E &= y + \\frac{v^2}{2g} \\\\
	...
	[
		// problem statement
		`A rectangular flume is built out of wood (!$n=0.012!$) and has a base width of !$1.250\\,\\mathsf{m}!$. The flume has a longitudinal slope of 0.14% and a flow depth of !$950\\,\\mathsf{mm}!$. Determine !$Q!$, the discharge, and the slope !$S_c!$ at which this flow becomes critical. What is the critical depth !$y_c!$ and the critical velocity !$v_c!$ for this !$Q!$?`,
		// part solutions
		[
			[
	...
	[
		// problem statement
		`<div class="inline-block width50 "><br/>A triangular flume, built from unplaned wood !$(n=0.013)!$, has a design flow of !$3.25\\,\\mathsf{m^3\\!\\!/s}!$. The sidewalls of the flume are inclined at !$45^{\\circ}!$ to the horizontal (i.e., !$z=1!$). If the slope of the flume is !$S=0.001!$, determine the depth !$y!$ of normal flow. Classify this flow. </div>
	...
	[
		...
		[
			[
				...
				`<div class="width80"><img src="./images/circularGuidedPractice1UnderHalf.png" /></div><div class="clear" />
                $$\\begin{aligned}
